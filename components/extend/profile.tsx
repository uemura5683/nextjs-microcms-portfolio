    ...
    <section id="p-about" className="has-animation animation-second" data-set-color="light">
      ...
      <article className="p-about__profile">
        ...
        <ul className="p-about__profile--list">
          ...
          <li><span>リンク</span><a href="https://twitter.com/uemuragame5683" target="_blank">Twitter</a> / <a href="https://github.com/uemura5683" target="_blank">GitHub</a> / <a href="https://nu-blogsite.net/" targe="_blank">Nu-Blog</a></li>
        </ul>
        <p className="p-about__profile--description">
          ...
          エンジニアとしていろんな言語・ビジネススキルを身につけ日々精進し、<br></br>
          仲間が困ったことがあったら、助けたい・力になりたいと思っています。<br></br><br></br>
      ...
      <article className="p-about__profile">
        ...
        <div className="about__profile__lessondetail">
          <p>
          2021年に公開した個人のポートフォリオサイト「NU-stack(ヌースタック)」<br></br><br></br>
          NU-stack(ヌースタック)は 自分のイニシャルとフルスタックエンジニアを組み合わせたサイト名です。<br></br><br></br>
