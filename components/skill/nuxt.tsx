          ...
          <div className="skill__zoom_modal">
            ...
            <div className="skill__zoom_modal_description">
              ...
              <p className="skill_detail">
                ...
                <br /><span>成果物</span><a href="https://nu-blogsite.net/" target="_blank">Nu-Blog</a>
                <br />
                <br /><span>LT資料</span><a href="https://speakerdeck.com/uemura/microcms-plus-nuxt-dot-jstege-ren-hurokusaitowotehuroisitajian" target="_blank">Microcms + nuxt.jsで個人ブログサイトをデプロイした件</a>
              </p>
