          ...
          <div className="skill__zoom_modal">
            ...
            <div className="skill__zoom_modal_description">
              ...
              <p className="skill_detail">
                ...
                ゆえに、実用性があり、効率よく作業を行うことが可能なため、Go言語は「軽量・高速・シンプル」なプログラミング言語として広く知られています。<br></br>
                goのマスコットキャラクターはgopherであり、日本語で訳すと「ホリネズミ」だそうです。<br></br>
                <br></br>成果物<br></br><a href="https://github.com/uemura5683/golang_typinggame" target="_blank">github タイピングゲーム</a>
                <br></br>LT資料<br></br><a href="https://speakerdeck.com/uemura/golang-dezhi-xian-shi-jian-fu-kirandamubiao-shi-falsetaipingugemuwozuo-tutemita" target="_blank">Golang で制限時間付き・ランダム表示のタイピングゲームを作ってみた。</a>
              </p>
