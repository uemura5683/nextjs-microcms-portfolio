    ...
    <section id="p-about" className="has-animation animation-second" data-set-color="light">
      ...
      <article className="p-about__profile">
        ...
        <ul className="p-about__profile--list">
          ...
          <li><span>リンク</span><a href="https://twitter.com/uemuragame5683" target="_blank">Twitter</a> / <a href="https://github.com/uemura5683" target="_blank">GitHub</a> / <a className="d-none" href="https://nu-blogsite.net/" target="_blank">Nu-Blog</a></li>
        </ul>
